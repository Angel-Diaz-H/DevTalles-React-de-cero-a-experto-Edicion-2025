...
export const InstagromApp = () => {
  ...
  const handleAddComment = async (formData: FormData) => {
    ...
    startTransition(async () => {
      ...
      //! Simular código para revertir el proceso.
  ...
  return (
    <div className="bg-slate-700 h-screen flex flex-col items-center justify-center">
      {/* Post de ejemplo */}
      <div className="flex flex-col h-[60vh] items-center justify-center bg-gray-300 rounded-t-4xl p-4 w-125">
        <img
          src="https://images.unsplash.com/photo-1649972904349-6e44c42644a7?w=500&h=500&fit=crop"
          alt="Instagrom"
          className="object-cover h-[48vh] rounded-4xl mb-4"
        />
